...
await sock.sendMessage(
  targetJid,
  {
    ...
    contextInfo: {
      ...
      externalAdReply: {
        title: "💐 𝐓ʜᴀɴᴋ 𝐘ᴏᴜ 𝐅ᴏʀ 𝐔sɪɴɢ 𝐄𝐈𝐌𝐋𝐈 ✘𝐌𝐃 𝐁𝐎𝐓 💞",
        body: "𝐌ʀ 𝐑ᴀʙʙɪᴛ",
        thumbnailUrl: "https://files.catbox.moe/56fmfy.jpg",
        sourceUrl: "https://whatsapp.com/channel/0029Vb7EqT7Fy728yCgwnZ3T",
        mediaType: 1,
...
const botMode = db.get(sessionId, "bot_mode", "public");

// 🤖 bot number JID
const botJid = sock.user?.id?.split(":")[0] + "@s.whatsapp.net";

// 👤 sender JID (group + private safe)
const senderJid = msg.key?.participant || msg.key?.remoteJid;

// 🔒 PRIVATE MODE হলে bot ছাড়া সবাই BLOCK
if (botMode === "private" && senderJid !== botJid) {
  return;
}
